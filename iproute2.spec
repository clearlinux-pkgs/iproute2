...
Source0  : https://mirrors.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.10.0.tar.gz
...
%prep
%setup -q -n iproute2-6.10.0
cd %{_builddir}/iproute2-6.10.0
pushd ..
cp -a iproute2-6.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721235238
