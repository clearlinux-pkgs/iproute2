...
Source0  : https://mirrors.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.0.0.tar.xz
...
%prep
%setup -q -n iproute2-6.0.0
cd %{_builddir}/iproute2-6.0.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664979128
