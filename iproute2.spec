...
Source0  : https://mirrors.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.6.0.tar.xz
...
Patch1: 0001-Use-systemwide-config-dir-for-usr.patch
...
%prep
%setup -q -n iproute2-6.6.0
cd %{_builddir}/iproute2-6.6.0
%patch -P 1 -p1
pushd ..
cp -a iproute2-6.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702320351
