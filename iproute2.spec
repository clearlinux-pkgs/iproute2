...
Source0  : https://mirrors.kernel.org/pub/linux/utils/net/iproute2/iproute2-5.17.0.tar.xz
...
%prep
%setup -q -n iproute2-5.17.0
cd %{_builddir}/iproute2-5.17.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647985537
...
cp %{_builddir}/iproute2-5.17.0/COPYING %{buildroot}/usr/share/package-licenses/iproute2/b47456e2c1f38c40346ff00db976a2badf36b5e3
%make_install
