...
Version  : 6.1.0
Release  : 77
URL      : https://mirrors.kernel.org/pub/linux/utils/net/iproute2/iproute2-v6.1.0.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/utils/net/iproute2/iproute2-v6.1.0.tar.xz
...
%prep
%setup -q -n iproute2-v6.1.0
cd %{_builddir}/iproute2-v6.1.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670889360
...
cp %{_builddir}/iproute2-v%{version}/COPYING %{buildroot}/usr/share/package-licenses/iproute2/b47456e2c1f38c40346ff00db976a2badf36b5e3 || :
%make_install
